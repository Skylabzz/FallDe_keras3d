...
CREATE TABLE `camera` (
  ...
  `line_token_id` int(11) DEFAULT NULL,
...
ALTER TABLE `camera`
  ...
  ADD KEY `line_token_id` (`line_token_id`),
...
ALTER TABLE `camera`
  ...
  ADD CONSTRAINT `camera_ibfk_3` FOREIGN KEY (`line_token_id`) REFERENCES `line_token` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
